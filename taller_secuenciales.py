...
#Primer ejercicio
valor1 = float(input("¿Cuánto dinero invirtió la primera persona?\n"))
valor2 = float(input("¿Cuánto dinero invirtió la segunda persona?\n"))
valor3 = float(input("¿Cuánto dinero invirtió la tercera persona?\n"))
...
#Segundo ejercicio
neto = float(input("Digite el salario base del empleado\n"))
hijos = int(input("Digite el numero de hijos que tiene el empleado\n"))
bonificacion = hijos * 80000
total = neto + bonificacion
...
monto = float(input("Digite el valor del préstamo\n"))
interes = monto * (0.24)
total = monto + interes
especiales = (total*0.5)/4
ordinarias = (total*0.5)/20
print(f"El valor total a pagar por el préstamo es: {total}, el valor de las cuatro cuotas especiales es: {especiales} y el de las 20 {ordinarias}")